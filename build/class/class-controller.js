...
exports.getAllClasses = function (req, res, next) {
    ...
    service.getAllClasses().then(function (classes) {
        mapper.mapClasses(classes).then(function (newClasses) {
            res.json(newClasses);
        }).catch(function (err) {
            console.log(err);
        });
...
exports.getNextClasses = function (req, res, next) {
    ...
    service.getNextClasses(numberOfClasses).then(function (classes) {
        mapper.mapClasses(classes).then(function (newClasses) {
            res.json(newClasses);
        }).catch(function (err) {
            console.log(err);
...
exports.getClassesBetweenDates = function (req, res, next) {
    ...
    service.getClassesBetweenDates(startDate, endDate).then(function (classes) {
        mapper.mapClasses(classes).then(function (newClasses) {
            res.json(newClasses);
        }).catch(function (err) {
            console.log(err);
...
exports.deleteClass = function (req, res, next) {
    ...
    service.deleteClass(classId).then(function (result) {
        console.log(result);
...
exports.addToClass = function (req, res, next) {
    ...
    attendanceService.addMemberToClass(hbId, classId).then(function (result) {
...
exports.removeFromClass = function (req, res, next) {
    ...
    attendanceService.removeMemberToClass(hbId, classId).then(function (result) {
...
exports.makeClassAGrading = function (req, res, next) {
    ...
    service.makeClassAGrading(classId).then(function (result) {
        console.log(result);
...
function createClassesLoop(classes, res) {
    if (classesindex < classes.length) {
        classesCreation(classes[classesindex]).then(function (result) {
...
function classesCreation(aclass) {
    return new Promise(function (resolve, reject) {
        Promise.all([classTypeService.getClassTypeIdByName(aclass.classType)]).then(function (results) {
            service.createClass(0, aclass.isGrading, new Date(aclass.date), results[0]).then(function (result) {
                resolve(result);
            }).catch(function (err) {
                console.log(err);
                reject(err);
